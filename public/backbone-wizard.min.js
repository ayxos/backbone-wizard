...
"circle"==this.shape&&f.append("circle").attr("r",10).style("fill","#fff").classed({rect:!1,circle:!0}),"rect"==this.shape){
//Width and height
var g=50,h=20;
// var barPadding = 1; 
...
// drag function
var i=50,j=0,k=d3.select("svg > g").attr("transform","translate("+i+", "+j+")"),l=function(a){a.call(d3.behavior.drag().on("drag",function(a){console.log("dragging",a),i+=d3.event.dx,j+=d3.event.dy,k.attr("transform","translate("+i+", "+j+")")}))};l(k),
// hover function
